...
public class GameScreen extends Screen {
    ...
    public void present(float deltaTime) {
        ...
        if (world.state == World.GameState.Running)
            drawMessage(world.getTime() + "  High:" + lastScore, c);
            ...
            if(Integer.parseInt(lastScore)  <  Integer.parseInt(world.getTime()))
            {
                lastScore = world.getTime();
            }
        }
    }
